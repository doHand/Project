...
//private static final Logger logger = LoggerFactory.getLogger(BoardController.class);
	...
	// 게시글 작성
	@PostMapping("/write")
	public String write(@ModelAttribute("content_view") MemberVO vo, String bName, String bTitle, String bContent,
	...
	public String content_viewPage(HttpSession session, Model model, int bId) {
		...
		//로그인한 사용자인 경우
		if (loggedInUserId != null) {
			String author = (String) session.getAttribute("id"); // 게시글 작성자
	        if(author != null && author.equals(content.getbName())) { // 현재 사용자가 게시글 작성자인지 확인
