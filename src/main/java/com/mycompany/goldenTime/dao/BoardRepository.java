...
public class BoardRepository implements IBoardRepository {
	...
	public void write(String bName, String bTitle, String bContent) {
		sqlSession.insert("com.mycompany.goldenTime.dao.IBoardRepository.write", new BoardVO(bName, bTitle, bContent));
	}
	...
	public void modify(int bId, String bTitle, String bContent) { 
		sqlSession.update("com.code911.goldentime.dao.IBoardRepository.modify", new BoardVO(bId, bTitle, bContent));
	}
